...
// void	event_request(struct pollfd *fds, std::vector<Listen> &server_fd, std::vector<t_conf> & conf, std::map<std::string, std::string> map_error) {
	
// 	for (int i = 0; i < MAX_CONNECTION; i++)
// 	{
// 		int event_request = fds[i].revents & POLLIN;
// 		if (event_request)
// 		{
...
// 			*/
// 				read_request(fds, i, buffer, conf, map_error);
// 			return ;
// 		}
// 	}
// }
...
// 		}
// 		event_request(fds, server_fd, conf, map_error);
// 	}
// }
